...
<li><a>Add</a><ul>
	...
	<li><a href="add_student.php">Add Student</a></li></ul>
			...
			<?php/**************************/?><br><br>
			<u><font size="10"  color="#FCF3CF">Add Course</font></u><br><br>
			<form action="connect/course.php" method="post">					
				...
				Department Name:		<input type="text" name="subject"><br><br>
				Main Subject: 		<input type="text" name="book"><br><br>					
				Subject Book 1:				<input size="10" type="text" name="book1">							
				Subject Book 2:				<input size="10" type="text" name="book2">									
				Subject Book 3:				<input size="10" type="text" name="book3"><br><br><br>
